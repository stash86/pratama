...
function replaceMagicSymbols($original, $withShadow=false)
{
	...
	$replace=[
		"<i class=\"ms ms-2$1 ms-split $stringManaCost\"></i>"
		,"<i class=\"ms ms-$1 $stringManaCost\"></i>"
		,"<i class=\"ms ms-untap $stringManaCost\"></i>"
		,"<i class=\"ms ms-tap $stringManaCost\"></i>"
		,'+'
		,"<i class=\"ms ms-loyalty-up ms-loyalty-$1\"></i>:"
		,"<i class=\"ms ms-loyalty-down ms-loyalty-$1\"></i>:"
		,"<i class=\"ms ms-$1$2 ms-split $stringManaCost\"></i>"
		,"<span class=\"ms-half\"><i class=\"ms ms-$1 $stringManaCost\"></i></span>"
		,'<i class="ms ms-chaos"></i>'
		,'<i class="ms ms-1-2"></i>'
		,'<i class="ms ms-1-2"></i>'
		,'<i class="ms ms-1-2"></i>'
		,"<i class=\"ms ms-infinity $stringManaCost\"></i>"
		,"<i class=\"ms ms-infinity $stringManaCost\"></i>"
		,"<i class=\"ms ms-loyalty-down ms-loyalty-X\"></i>:"
	];
